...
st.markdown(
    "<h1 style='font-size:20px; font-family:Arial; color:grey;'text-align: center;'>Photos de charme accessibles gratuitement, créé-toi un compte premium si tu veux tout voir 😈</h1>", 
    unsafe_allow_html=True
)
